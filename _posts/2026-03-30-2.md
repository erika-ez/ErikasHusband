...
title:  nothing important happens in Tucson! (just kidding)
---
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/ambitious_itinerary.jpg" | relative_url }}" alt="The ambitious itinerary I created for the day trip to Tucson, AZ" style="max-width:50%; height:auto;">
	<figcaption style="font-style: italic; font-size: 0.9em;">The ambitious itinerary in question.</figcaption>
</figure>	
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/hyperglossia_rosary.jpg" | relative_url }}" alt="Hyperglossia, Stacy Szymaszek and The Thorn Rosary, Eileen R. Tabios." style="max-width:50%; height:auto;">
	<figcaption style="font-style: italic; font-size: 0.9em;">Some books I read at the UArizona Poetry Center.</figcaption>
</figure>
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/slowcrush_shesgreen.jpg" | relative_url }}" alt="Left: Slow Crush; Right: She's Green" style="max-width:100%; height:auto;">
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/jaimes_pizza.jpg" | relative_url }}" alt="Pizza from Jaime's Pizza Kitchen in Tucson" style="max-width:50%; height:auto;">
