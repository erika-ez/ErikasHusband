...
<figure style="text-align: center;">
	<img src="{{ "assets/images/shirts_collage_white2.jpg" | relative_url }}" alt="Four white shirts I own. " style="max-width:50%; height:auto;">
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/white_shirt_collage_black_borders.jpg‎" | relative_url }}" alt=""Me posing wearing white shirts trying to be aesthetic and cool." style="max-width:75%; height:auto;">
