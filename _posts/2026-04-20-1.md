...
<figure style="text-align: center;">
	<img src="{{ "assets/images/mars_or_az.jpg" | relative_url }}" alt="Arizona near the California border." style="max-width:75%; height:auto;">
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/palm_springs.jpg" | relative_url }}" alt="Palm Springs, CA." style="max-width:75%; height:auto;">
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/susuru_LA.jpg" | relative_url }}" alt="Susuru, a bar-style ramen restaurant in L.A." style="max-width:75%; height:auto;">
...
<figure style="text-align: center;">
	<img src="{{ "assets/images/ozempic_ad.jpg" | relative_url }}" alt="A billboard sign for Ozempic in California." style="max-width:75%; height:auto;">
